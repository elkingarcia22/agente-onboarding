...
# I used this exact string in my previous python script:
...
if new_str in content:
    content = content.replace(new_str, '{id:"onboarding",title:"Onboarding",category:"Onboarding",icon:ph,iconColor:"text-gray-500",number:10,children:null}')
